    ...
    <div id="primary" class="content-area">
        ...
        <main id="main" class="site-main">
            ...
            <div class="p-5 text-center bg-body-tertiary rounded mb-4">
                <h1 class="entry-title display-4 mb-4"><?php echo __( 'Company overview', 'jpkcom-acf-jobs' ); ?></h1>
            </div>
            ...
            <?php else : ?>
                <div class="alert alert-info" role="alert">
                    <p><?php echo __( 'There are currently no companies available.', 'jpkcom-acf-jobs' ); ?></p>
                </div>
            <?php endif; ?>
