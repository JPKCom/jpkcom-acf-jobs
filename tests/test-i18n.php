 ...
 *
 * Why this exists: the .pot was generated in October 2025 and never again. It
 * held 64 entries while includes/abilities.php alone had 129 translatable
 * strings, so the entire Abilities API surface shipped untranslated in 1.4.0 and
 * 1.5.0 and nothing said so. Regenerating was neither automated nor on the
 * release checklist. This turns that into a red build.
 *
...
$slug   = 'jpkcom-acf-jobs';
$domain = 'jpkcom-acf-jobs';
